...
if [ ! -d "data/FB15k-237" ]; then
  ...
  unzip FB15k-237.zip
  cd ..
  python3 preprocess.py FB15k-237
else
...
if [ ! -d "data/dbpedia50" ]; then
  ...
  cd ..
  python3 preprocess.py dbpedia50
else
...
if [ ! -d "data/dbpedia500" ]; then
  ...
  cd ..
  python3 preprocess.py dbpedia500
else
...
if [ ! -d "data/YAGO3-10" ]; then
  ...
  cd ..
  python3 preprocess.py YAGO3-10
else
